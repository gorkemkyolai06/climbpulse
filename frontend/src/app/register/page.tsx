  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 py-8">
      <div className="mb-6 text-center">
        <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded border-l-4 border-l-accent bg-primary text-primary-foreground shadow-sm">
          <Mountain className="h-7 w-7" strokeWidth={2} />
        </div>
        <h1 className="font-display text-3xl font-bold">Salon Kaydı</h1>
      </div>

      <Card className="grit-card w-full max-w-lg">
        <CardHeader>
          <CardTitle className="font-display text-2xl">Yeni Tırmanış Salonu Oluştur</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="climbingGymName">Salon Adı</Label>
              <Input
                id="climbingGymName"
                value={form.climbingGymName}
                onChange={(e) => update('climbingGymName', e.target.value)}
                required
                placeholder="Vertical Grit Climbing"
              />
            </div>
            <div className="space-y-2">
